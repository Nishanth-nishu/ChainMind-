...
#   5. Saves results + logs to run_v6/ subdirectory on scratch
#
# Submit:  sbatch run_full_selfcontained.sh
# Monitor: tail -f /scratch/nishanth.r/sys_elvle_ai/run_v6/slurm_logs/run_v6_<JOB_ID>.log
# =============================================================================
#SBATCH -A plafnet2
#SBATCH -p plafnet2
...
#SBATCH --output=/scratch/nishanth.r/sys_elvle_ai/run_v6/slurm_logs/run_v6_%j.log
...
# ── LINK results into run_v6 so the runner writes there ───────────────────
